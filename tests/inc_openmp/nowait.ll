; ModuleID = '/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp/21_single_nowait.c'
source_filename = "/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp/21_single_nowait.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.ident_t = type { i32, i32, i32, i32, ptr }

@0 = private unnamed_addr constant [82 x i8] c";/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp/21_single_nowait.c;main;11;0;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 81, ptr @0 }, align 8
@2 = private unnamed_addr constant [82 x i8] c";/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp/21_single_nowait.c;main;14;0;;\00", align 1
@3 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 81, ptr @2 }, align 8
@4 = private unnamed_addr constant [82 x i8] c";/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp/21_single_nowait.c;main;19;0;;\00", align 1
@5 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 81, ptr @4 }, align 8
...
omp_region.end:                                   ; preds = %omp.par.entry, %omp.single.region6
  %omp_global_thread_num8 = tail call i32 @__kmpc_global_thread_num(ptr nonnull @5), !dbg !19
  %1 = tail call i32 @__kmpc_single(ptr nonnull @5, i32 %omp_global_thread_num8), !dbg !19
  %.not1 = icmp eq i32 %1, 0
  br i1 %.not1, label %omp.par.outlined.exit.exitStub, label %omp.single.region13

omp.single.region13:                              ; preds = %omp_region.end
  tail call void @__kmpc_end_single(ptr nonnull @5, i32 %omp_global_thread_num8), !dbg !19
...
omp.par.outlined.exit.exitStub:                   ; preds = %omp_region.end, %omp.single.region13
  ret void
}
...
!2 = !DIFile(filename: "21_single_nowait.c", directory: "/home/walterjtv/Escritorio/Q8/TFG/tutorial/openmp")
...
!4 = !DIFile(filename: "21_single_nowait.c", directory: "")
